...
# Playwright MCP tools for browser automation (alternative/fallback to Puppeteer)
PLAYWRIGHT_TOOLS = [
...
def create_client(project_dir: Path, model: str) -> ClaudeSDKClient:
    ...
    security_settings = {
        ...
        "permissions": {
            ...
            "allow": [
                ...
                *PUPPETEER_TOOLS,
                # Allow Playwright MCP tools for browser automation (alternative)
                *PLAYWRIGHT_TOOLS,
    ...
    print("   - MCP servers: puppeteer, playwright (browser automation), linear (project management)")
    print()
